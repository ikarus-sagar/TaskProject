...
from routes.blog_routes import update_blog_route , delete_blog_route , BlogIn
from routes.user_routes import update_user_route , delete_user_route , UserIn

def test_update_user_invalid_id():
    try:
        updated_user = update_user_route("invalid_id", UserIn(
            name="test",
...
def test_update_blog_invalid_id():
    try:
        updated_blog = update_blog_route("invalid_id", BlogIn(
            title="test",
            content="test",
            creator="test"
        ))
